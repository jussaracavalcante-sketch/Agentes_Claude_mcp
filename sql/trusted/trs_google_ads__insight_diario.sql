...
anuncio AS (
  ...
  UNION ALL
  SELECT 'ANUNCIO','google-ads-3eFc',SAFE_CAST(id AS STRING),campaign_id,campaign_name,campaign_status,SAFE_CAST(ad_group_id AS INT64),NULLIF(TRIM(SAFE_CAST(ad_group_name AS STRING)),''),SAFE_CAST(ad_group_ad_ad_id AS INT64),NULLIF(TRIM(SAFE_CAST(ad_group_ad_ad_name AS STRING)),''),date,metrics_cost_micros,metrics_impressions,metrics_clicks,metrics_interactions,metrics_video_views,metrics_conversions,metrics_conversions_value,metrics_all_conversions,metrics_all_conversions_value,metrics_view_through_conversions,metrics_ctr,metrics_interaction_rate,metrics_conversions_from_interactions_rate,metrics_absolute_top_impression_percentage,metrics_top_impression_percentage,metrics_average_cpc,metrics_average_cpm FROM `vanguardamartech_unipar_boa_vista`.`google_ads_unipar_boa_vistaad_performance`
  UNION ALL
  SELECT 'ANUNCIO','google-ads-mvUx',SAFE_CAST(id AS STRING),campaign_id,campaign_name,campaign_status,SAFE_CAST(ad_group_id AS INT64),NULLIF(TRIM(SAFE_CAST(ad_group_name AS STRING)),''),SAFE_CAST(ad_group_ad_ad_id AS INT64),NULLIF(TRIM(SAFE_CAST(ad_group_ad_ad_name AS STRING)),''),date,metrics_cost_micros,metrics_impressions,metrics_clicks,metrics_interactions,metrics_video_views,metrics_conversions,metrics_conversions_value,metrics_all_conversions,metrics_all_conversions_value,metrics_view_through_conversions,metrics_ctr,metrics_interaction_rate,metrics_conversions_from_interactions_rate,metrics_absolute_top_impression_percentage,metrics_top_impression_percentage,metrics_average_cpc,metrics_average_cpm FROM `vanguardamartech_unipar_neo_vila`.`google_ads_unipar_neo_vilaad_performance`
  UNION ALL
  SELECT 'ANUNCIO','google-ads-hBlk',SAFE_CAST(id AS STRING),campaign_id,campaign_name,campaign_status,SAFE_CAST(ad_group_id AS INT64),NULLIF(TRIM(SAFE_CAST(ad_group_name AS STRING)),''),SAFE_CAST(ad_group_ad_ad_id AS INT64),NULLIF(TRIM(SAFE_CAST(ad_group_ad_ad_name AS STRING)),''),date,metrics_cost_micros,metrics_impressions,metrics_clicks,metrics_interactions,metrics_video_views,metrics_conversions,metrics_conversions_value,metrics_all_conversions,metrics_all_conversions_value,metrics_view_through_conversions,metrics_ctr,metrics_interaction_rate,metrics_conversions_from_interactions_rate,metrics_absolute_top_impression_percentage,metrics_top_impression_percentage,metrics_average_cpc,metrics_average_cpm FROM `vanguardamartech_unipar_torres`.`google_ads_unipar_torresad_performance`
),
campanha AS (
  ...
  UNION ALL
  SELECT 'CAMPANHA','google-ads-3eFc',SAFE_CAST(id AS STRING),campaign_id,campaign_name,campaign_status,CAST(NULL AS INT64),CAST(NULL AS STRING),CAST(NULL AS INT64),CAST(NULL AS STRING),date,metrics_cost_micros,metrics_impressions,metrics_clicks,metrics_interactions,metrics_video_views,metrics_conversions,metrics_conversions_value,metrics_all_conversions,metrics_all_conversions_value,metrics_view_through_conversions,metrics_ctr,metrics_interaction_rate,metrics_conversions_from_interactions_rate,metrics_absolute_top_impression_percentage,metrics_top_impression_percentage,metrics_average_cpc,metrics_average_cpm FROM `vanguardamartech_unipar_boa_vista`.`google_ads_unipar_boa_vistacampaign_performance`
  UNION ALL
  SELECT 'CAMPANHA','google-ads-mvUx',SAFE_CAST(id AS STRING),campaign_id,campaign_name,campaign_status,CAST(NULL AS INT64),CAST(NULL AS STRING),CAST(NULL AS INT64),CAST(NULL AS STRING),date,metrics_cost_micros,metrics_impressions,metrics_clicks,metrics_interactions,metrics_video_views,metrics_conversions,metrics_conversions_value,metrics_all_conversions,metrics_all_conversions_value,metrics_view_through_conversions,metrics_ctr,metrics_interaction_rate,metrics_conversions_from_interactions_rate,metrics_absolute_top_impression_percentage,metrics_top_impression_percentage,metrics_average_cpc,metrics_average_cpm FROM `vanguardamartech_unipar_neo_vila`.`google_ads_unipar_neo_vilacampaign_performance`
  UNION ALL
  SELECT 'CAMPANHA','google-ads-hBlk',SAFE_CAST(id AS STRING),campaign_id,campaign_name,campaign_status,CAST(NULL AS INT64),CAST(NULL AS STRING),CAST(NULL AS INT64),CAST(NULL AS STRING),date,metrics_cost_micros,metrics_impressions,metrics_clicks,metrics_interactions,metrics_video_views,metrics_conversions,metrics_conversions_value,metrics_all_conversions,metrics_all_conversions_value,metrics_view_through_conversions,metrics_ctr,metrics_interaction_rate,metrics_conversions_from_interactions_rate,metrics_absolute_top_impression_percentage,metrics_top_impression_percentage,metrics_average_cpc,metrics_average_cpm FROM `vanguardamartech_unipar_torres`.`google_ads_unipar_torrescampaign_performance`
),
anuncio_chave AS (
