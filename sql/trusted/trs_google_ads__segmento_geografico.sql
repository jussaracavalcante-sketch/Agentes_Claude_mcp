...
WITH uniao AS (
  SELECT
    ...
    x.location_type AS tipo_localizacao,
    x.date,
  ...
  FROM `vanguardamartech_acesso_saude_google_ads`.`google_ads_acesso_saudegeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_ola_casa_nova_g_ads`.`google_ads_ola_casa_novageographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_move_rental_cars_g_ads`.`google_ads_move_rentalgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_don_watches_conta_1_g_ads`.`google_ads_don_watches_2geographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_don_watches_conta_2`.`google_ads_watches_2geographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_varejo`.`google_ads_braga_varejogeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_yamaha_consorcios_2`.`google_ads_yamaha_2geographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_yamaha_consorcios`.`google_ads_braga_yamaha_consorcgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_royal_enfield`.`google_ads_royal_enfieldgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_acessorios`.`google_ads_braga_acessoriosgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_veiculos`.`google_ads_pos_vendasgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_motors_mini`.`google_ads_braga_minigeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_motorrad`.`google_ads_braga_motorradgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_motors_bmw_g_ads`.`google_ads_braga_bmwgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_dmelo`.`google_ads_dmelogeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_caa`.`google_ads_caa_tintasgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_caa_aluminio`.`google_ads_caa_aluminiogeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_rodrix_g_ads`.`google_ads_rodrix_motosgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_deb_transportadora_g_ads`.`google_ads_deb_transportadorageographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_rei_das_mangueiras_g_ads`.`google_ads_rei_das_mangueirasgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pneu_forte_distribuidora`.`google_ads_pneu_forte_distgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_millenium_g_ads`.`google_ads_milleniumgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pneu_express`.`google_ads_pneu_expressgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_smile_pneus`.`google_ads_smile_pneusgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_steel_port_g_ads`.`google_ads_steel_portgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_amz_geradores_g_ads`.`google_ads_amz_geradoresgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_dr_cabral_conta_1`.`google_ads_dr_cabral_1geographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_santo_remedio_g_ads`.`google_ads_santo_remediogeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_hospital_santa_julia_g_ads`.`google_ads_h_santa_juliageographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_constroi_incorporadora_g_ads`.`google_ads_constroigeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_doctor_mais_g_ads`.`google_ads_doctor_maisgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_colmeia`.`google_ads_colmeiageographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_amazoncopy_g_ads`.`google_ads_amazoncopygeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_bigazine_g_ads`.`google_ads_bigazinegeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_arena_tintas_g_ads`.`google_ads_arena_tintasgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_ba_eletrica_g_ads`.`google_ads_ba_eletricageographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pmz_grupo_ecomm`.`google_ads_pmz_ecommgeographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pmz_loja`.`google_pmz_grupo_lojageographic_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pmz_escola_de_mecanicos`.`google_ads_pmz_escola_mecanicosgeographic_performance` x
)
SELECT
  u.id_conta,
  u.id_campanha,
