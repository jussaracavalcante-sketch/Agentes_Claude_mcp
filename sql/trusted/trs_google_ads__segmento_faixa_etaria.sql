...
-- R$ 1.091.904,50 dos R$ 1.361.954,19 de verba (80,2%); a verba nao-PMax e
-- R$ 1.090.513,58 (80,1%) e o delta de R$ 1.390,92 e o dia 03/09 parcial.
...
WITH uniao AS (
  ...
  FROM `vanguardamartech_acesso_saude_google_ads`.`google_ads_acesso_saudeage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_ola_casa_nova_g_ads`.`google_ads_ola_casa_novaage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_move_rental_cars_g_ads`.`google_ads_move_rentalage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_don_watches_conta_1_g_ads`.`google_ads_don_watches_2age_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_don_watches_conta_2`.`google_ads_watches_2age_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_varejo`.`google_ads_braga_varejoage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_yamaha_consorcios_2`.`google_ads_yamaha_2age_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_yamaha_consorcios`.`google_ads_braga_yamaha_consorcage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_royal_enfield`.`google_ads_royal_enfieldage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_acessorios`.`google_ads_braga_acessoriosage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_veiculos`.`google_ads_pos_vendasage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_motors_mini`.`google_ads_braga_miniage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_motorrad`.`google_ads_braga_motorradage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_braga_motors_bmw_g_ads`.`google_ads_braga_bmwage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_dmelo`.`google_ads_dmeloage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_caa`.`google_ads_caa_tintasage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_caa_aluminio`.`google_ads_caa_aluminioage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_rodrix_g_ads`.`google_ads_rodrix_motosage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_deb_transportadora_g_ads`.`google_ads_deb_transportadoraage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_rei_das_mangueiras_g_ads`.`google_ads_rei_das_mangueirasage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pneu_forte_distribuidora`.`google_ads_pneu_forte_distage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_millenium_g_ads`.`google_ads_milleniumage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pneu_express`.`google_ads_pneu_expressage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_smile_pneus`.`google_ads_smile_pneusage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_steel_port_g_ads`.`google_ads_steel_portage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_amz_geradores_g_ads`.`google_ads_amz_geradoresage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_dr_cabral_conta_1`.`google_ads_dr_cabral_1age_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_santo_remedio_g_ads`.`google_ads_santo_remedioage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_hospital_santa_julia_g_ads`.`google_ads_h_santa_juliaage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_constroi_incorporadora_g_ads`.`google_ads_constroiage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_doctor_mais_g_ads`.`google_ads_doctor_maisage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_colmeia`.`google_ads_colmeiaage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_amazoncopy_g_ads`.`google_ads_amazoncopyage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_bigazine_g_ads`.`google_ads_bigazineage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_arena_tintas_g_ads`.`google_ads_arena_tintasage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_ba_eletrica_g_ads`.`google_ads_ba_eletricaage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pmz_grupo_ecomm`.`google_ads_pmz_ecommage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pmz_loja`.`google_pmz_grupo_lojaage_range_performance` x
  UNION ALL
  SELECT
    ...
    x.metrics_cross_device_conversions,
    TO_HEX(MD5(TO_JSON_STRING(x))) AS _payload_hash
  FROM `vanguardamartech_pmz_escola_de_mecanicos`.`google_ads_pmz_escola_mecanicosage_range_performance` x
)
SELECT
  u.id_conta,
  u.id_campanha,
